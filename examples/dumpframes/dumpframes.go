...
github.com/Servicewall/xdp package, it sets up an XDP socket attached to a
...
import (
	...
	"github.com/Servicewall/xdp"
	"github.com/Servicewall/xdp/examples/dumpframes/ebpf"
